...
class pose_estimation:
    ...
    def __init__(self):
        ...
        # real
        self.K = np.array(
            [[1562.58456, 0, 673.30261], [0, 1563.35611, 476.27193], [0, 0, 1]])
        self.D = np.array([-0.109411,  0.234479, -0.001090, 0.003335, 0])

        img = cv2.imread('/home/masters/catkin_ws/src/visual/src/my_aruco_tracker/Images/goal_pose.png')
        self.goal_pose = []
